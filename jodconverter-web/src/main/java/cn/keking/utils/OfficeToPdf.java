...
public class OfficeToPdf {
    ...
    public  boolean openOfficeToPDF(String inputFilePath, String outputFilePath) {
        //这个地方又问题,需要改造 Mars_Lv
//        return office2pdf(inputFilePath, outputFilePath);
        return filePreviewoffice2pdf(inputFilePath,outputFilePath);
    }
     ...
     * @return
     */
    public  boolean filePreviewoffice2pdf(String inputFilePath, String outputFilePath) {
        boolean flag = false;
